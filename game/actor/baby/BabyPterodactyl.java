...
import game.actor.dinosaur.Pterodactyl;
import game.actor.dinosaur.Stegosaur;

/**
 * Class representing a baby Pterodactyl
 */
public class BabyPterodactyl extends Dinosaur {
     ...
     */
    public BabyPterodactyl(String name) {
        super(name, 'p', 10, 100, 100);
     ...
     */
    public BabyPterodactyl(String name, char b) {
